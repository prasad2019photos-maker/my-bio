...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Prsad — I build websites for fun." },
      {
        name: "description",
        content:
    ...
    links: [
      ...
      { rel: "icon", href: "/logo2.png", type: "image/png", sizes: "any" },
      { rel: "shortcut icon", href: "/favicon.ico" },
      { rel: "apple-touch-icon", href: "/logo2.png", sizes: "180x180" },
    ],
  }),
